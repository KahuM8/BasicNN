...
public class a2Part1 {
    ...
    public static void main(String[] _ignored) {
        ...
        // TODO: Perform a single backpropagation pass using the first instance only. (In other
        // words, train with 1
        ...
        double[][][] error = nn.backward_propagate_error(instances[0], outputs[0], outputs[1],
                onehot_encoded[0][0]);
        ...
        double accuracy =
                nn.getAccuracy(instances_test, labels_test, label_encoder, predicted_labels);
