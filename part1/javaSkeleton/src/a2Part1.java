...
public class a2Part1 {
        ...
        public static void runTests(boolean biases, int epoch, double learning , boolean sTesting) {
                ...
                if (!sTesting)System.out.println(Arrays.deepToString(instances));
                ...
                if (!sTesting)System.out.println("Predicted label for the first instance is: "
                                + instance1_predicted_label);

                if (!sTesting)System.out.println();

                if (!sTesting)System.out.println("Hidden initial weights: " + Arrays.deepToString(initial_hidden_layer_weights));
                if (!sTesting)System.out.println("Output initial weights: " + Arrays.deepToString(initial_output_layer_weights));
                ...
                if (!sTesting)System.out.println("Weights after performing BP for first instance only:");
                if (!sTesting)System.out.println("Hidden layer weights:\n"
                                + Arrays.deepToString(nn.hidden_layer_weights));
                if (!sTesting)System.out.println("Output layer weights:\n"
                ...
                if (!sTesting)System.out.println("Finished!");
